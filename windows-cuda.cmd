...
start cmd /c ".\bin\windows-cuda\llama-server.exe -m .\models\llama3.1-8b.gguf --port 8088"
start cmd /c ".\bin\windows-cuda\llama-server.exe -m .\models\llama3.1-8b.gguf --port 8086 --embedding"
timeout /t 5
